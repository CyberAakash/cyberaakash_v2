/**
 * Link Preview component from Aceternity UI
 */
"use client";
...
export const LinkPreview = ({
  ...
  if (!isStatic) {
    ...
    params.set("embed", "screenshot");
    params.set("colorScheme", "dark");
    params.set("viewport", "1200x630");
  ...
  const handleMouseMove = (event: any) => {
    ...
    const offset = eventX - targetRect.left;
    const value = (offset / width) * 20 - 10;
    x.set(value);
  };
